...
public:
    ...
    void dealCards(Player& _p1, Player& _p2);
    void playTurn();
    ...
    void breakTie(); // In case of a tie, both players place a card face down, and open a new card. The winner takes the six cards.
};